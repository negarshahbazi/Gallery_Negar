 ...
 */
final class Version20240430073100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD gender_id INT DEFAULT NULL, ADD address VARCHAR(255) NOT NULL, ADD tel VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP gender_id, DROP address, DROP tel');
    }
}
